...
public class DebtController {
    ...
    public DebtController(DebtRepository debtRepo, ParticipantRepository partRepo, EventRepository eventRepo) {
    ...
    public ResponseEntity<List<Debt>> getAllByCreditorId(@PathVariable("creditor-id") Long id) {
        ...
        return ResponseEntity.ok(debtRepo.findAllByCreditorId(id));
    }
}
